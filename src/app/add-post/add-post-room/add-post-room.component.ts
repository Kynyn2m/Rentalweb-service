...
@Component({
  selector: 'app-add-post-room',
  templateUrl: './add-post-room.component.html',
  styleUrls: ['./add-post-room.component.css'],
})
export class AddPostRoomComponent {
      ...
      this.roomService.createPost(formData).subscribe(
        (response) => {
          Swal.fire({
            ...
            icon: 'success',
            confirmButtonText: 'Go to Room Listings',
